    ...
    const fetchSocialLinks = async () => {
      try {
        ...
        setSocialLinks([
          ...
          { _id: "3", name: "Instagram", icon: "ig", url: "#" },
          { _id: "4", name: "Twitter", icon: "tw", url: "#" }
        ]);
      }
    };
      ...
      <form className="contact-box" onSubmit={handleSubmit}>
        ...
        <div className="socials">
          {socialLinks.map((item) => {
            ...
            } else if (item.name.toLowerCase().includes('github')) {
              icon = (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            } else if (item.name.toLowerCase().includes('email') || item.name.toLowerCase().includes('mail')) {
              icon = (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
